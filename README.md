...
location: India 🇮🇳
status: "Building the Foreign Student Portal for BHU"
learning: [Next.js, System Architecture, GraphQL]
collaboration: "Open Source React/Node.js projects"
positions:
  - Web Master @ IEEE
  - Design Coordinator @ GDG
expertise: [JavaScript, React, Strapi CMS, UI/UX Design]
fun_fact: "I debug bugs like Sherlock solves cases 🕵️"
motto: "Code. Create. Conquer."</pre>
    </td>
